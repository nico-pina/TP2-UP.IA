...
- **Entrenamiento y optimización (`04`, x2):** En un principio de entrenaron tres modelos (Decision Tree, RandomForest y XGBoost), sin embargo, el primer se descartó por un bajo desempeño en las métricas. Por este motivo, solo se compararon Random Forest y XGBoost, cada uno en versión base y optimizada con `GridSearchCV` (5-fold, `scoring="f1"`):
